...
export default {
    ...
    beforeMount (){
        ...
        axios.get('http://localhost:3000/admin/vehicle/getAll')
            .then(response => {
    ...
    methods: {
        addVehicle: function(input_vehicle){
            axios.post(`http://localhost:3000/admin/vehicle`, input_vehicle)
                .then(response => {
                    this.vehicles = response.data.data
                }).catch(e => {
                    console.log(e);
        ...
        editVehicle: function(input_vehicle){
            axios.put(`http://localhost:3000/admin/vehicle/${input_vehicle.id}`, input_vehicle)
                .then(response => {
                    this.vehicles = response.data.data
                }).catch(e => {
                    console.log(e);
        ...
        deleteVehicle: function(input_vehicle){
            axios.delete(`http://localhost:3000/admin/vehicle/${input_vehicle.id}`)
                .then(response => {
                    this.vehicles = response.data.data
                }).catch(e => {
                    console.log(e);
