...
export default {
    ...
    beforeMount (){
        axios.get(`https://atirma.iusiani.ulpgc.es:3000/admin/role/${this.$route.params.id}`)
            .then(response => {
    ...
    methods: {
        editRole: function(input_role){
            axios.put(`https://atirma.iusiani.ulpgc.es:3000/admin/role/${this.$route.params.id}`, input_role)
                .then(() => {
