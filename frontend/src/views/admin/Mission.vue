...
export default {
    ...
    props:['user_perms'],
    beforeMount (){
        axios.get(`http://localhost/api/admin/mission/${this.$route.params.id}`)
            .then(response => {
    ...
    methods: {
        editMission: function(input_mission){
            axios.put(`http://localhost/api/admin/mission/${this.$route.params.id}`, input_mission)
                .then(() => {
        ...
        deleteMission: function(){
            axios.delete(`http://localhost/api/admin/mission/${this.$route.params.id}`)
                .then(() => {
