...
export default {
    ...
    props:['user_perms'],
    beforeMount (){
        axios.get(`http://15.188.10.32/api/admin/mission/${this.$route.params.id}`)
            .then(response => {
    ...
    methods: {
        editMission: function(input_mission){
            axios.put(`http://15.188.10.32/api/admin/mission/${this.$route.params.id}`, input_mission)
                .then(() => {
        ...
        deleteMission: function(){
            axios.delete(`http://15.188.10.32/api/admin/mission/${this.$route.params.id}`)
                .then(() => {
