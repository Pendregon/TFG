...
export default {
    ...
    beforeMount (){
        axios.get(`https://atirma.iusiani.ulpgc.es:3000/admin/vehicle/${this.$route.params.id}`)
        .then(response => {
    ...
    methods: {
        editVehicle: function(input_vehicle){
            axios.put(`https://atirma.iusiani.ulpgc.es:3000/admin/vehicle/${this.$route.params.id}`, input_vehicle)
                .then(() => {
        ...
        deleteVehicle: function(){
            axios.delete(`https://atirma.iusiani.ulpgc.es:3000/admin/vehicle/${this.$route.params.id}`)
                .then(() => {
