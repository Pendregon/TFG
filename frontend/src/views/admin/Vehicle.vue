...
export default {
    ...
    beforeMount (){
        axios.get(`http://localhost:3000/admin/vehicle/${this.$route.params.id}`)
        .then(response => {
    ...
    methods: {
        editVehicle: function(input_vehicle){
            axios.put(`http://localhost:3000/admin/vehicle/${this.$route.params.id}`, input_vehicle)
                .then(() => {
        ...
        deleteVehicle: function(){
            axios.delete(`http://localhost:3000/admin/vehicle/${this.$route.params.id}`)
                .then(() => {
