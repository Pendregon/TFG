...
<script>
    ...
    export default {
        ...
        beforeMount() {
            ...
            axios.get(`https://atirma.iusiani.ulpgc.es/api/admin/vehicle/${this.$route.params.id}/missions`)
                .then(response => {
        ...
        methods: {
            addMissionVehicle: function(data){
                axios.put(`https://atirma.iusiani.ulpgc.es/api/admin/vehicle/${this.$route.params.id}/missions/${data.mission}`)
                    .then(response => {
                        this.mission_vehicles = response.data.data
                    }).catch(e => {
                        console.log(e);
            ...
            deleteMissionVehicle: function(item){
                axios.delete(`https://atirma.iusiani.ulpgc.es/api/admin/vehicle/${this.$route.params.id}/missions/${item.id}`)
                    .then(response => {
                        this.mission_vehicles = response.data.data
                    }).catch(e => {
                        console.log(e);
