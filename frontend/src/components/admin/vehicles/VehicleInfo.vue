...
<script>
    ...
    export default {
        ...
        beforeMount() {
            ...
            axios.get(`http://localhost:3000/admin/vehicle/${this.$route.params.id}/missions`)
                .then(response => {
        ...
        methods: {
            addMissionVehicle: function(data){
                axios.put(`http://localhost:3000/admin/vehicle/${this.$route.params.id}/missions/${data.mission}`)
                    .then(response => {
                        this.mission_vehicles = response.data.data
                    }).catch(e => {
                        console.log(e);
            ...
            deleteMissionVehicle: function(item){
                axios.delete(`http://localhost:3000/admin/vehicle/${this.$route.params.id}/missions/${item.id}`)
                    .then(response => {
                        this.mission_vehicles = response.data.data
                    }).catch(e => {
                        console.log(e);
