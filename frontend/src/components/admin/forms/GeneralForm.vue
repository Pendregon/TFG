...
export default {
    ...
    beforeMount (){
        ...
        if(this.type =='addMission'){
            ...
            axios.get(`${this.$store.state.api_url}/admin/mission/${this.$route.params.id}/vehicles/getPossibleVehicles`)
                .then(response => {
            ...
            axios.get(`${this.$store.state.api_url}/admin/role/${this.$route.params.id}/getPossiblePerms`)
                .then(response => {
                    this.formData[0].fields[0].options = response.data.data
                }).catch(e => {
                    console.log(e);
            ...
            axios.get(`${this.$store.state.api_url}/admin/vehicle/${this.$route.params.id}/missions/getPossibleMissions`)
                .then(response => {
                    this.formData[0].fields[0].options = response.data.data
                }).catch(e => {
                    console.log(e);
            ...
            // let possible_roles = []
            axios.get(`${this.$store.state.api_url}/admin/user/getRoles`)
                .then(response => {
